...
def test_positive(client_api, task_data):
    ...
    assert body["project_id"] == task_db.project.pk
    assert body["project_name"] == task_db.project.name
    assert body["project_url"] == f"http://testserver/project/{task_db.project.pk}/"
